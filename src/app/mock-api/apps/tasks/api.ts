...
import { CustomizationMockApiUtils } from '@customization/lib/mock-api/mock-api.utils';
    ...
    registerHandlers(): void
    {
        ...
        this._customizationMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newTag.id = CustomizationMockApiUtils.guid();
        ...
        this._customizationMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new task
                const newTask = {
                    id       : CustomizationMockApiUtils.guid(),
