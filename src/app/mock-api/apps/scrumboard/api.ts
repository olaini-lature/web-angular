...
import { CustomizationMockApiService, CustomizationMockApiUtils } from '@customization/lib/mock-api';
    ...
    registerHandlers(): void
    {
        ...
        this._customizationMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newList.id = CustomizationMockApiUtils.guid();
        ...
        this._customizationMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newCard.id = CustomizationMockApiUtils.guid();
        ...
        this._customizationMockApiService
            ...
            .reply(({request}) => {
                ...
                // Generate a new GUID
                newLabel.id = CustomizationMockApiUtils.guid();
