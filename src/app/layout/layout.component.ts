...
import { CUSTOMIZATION_VERSION } from '@customization/version';
...
export class LayoutComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        combineLatest([
            ...
            this._customizationMediaWatcherService.onMediaQueryChange$(['(prefers-color-scheme: dark)', '(prefers-color-scheme: light)'])
        ]).pipe(
        ...
        // Set the app version
        this._renderer2.setAttribute(this._document.querySelector('[ng-version]'), 'customization-version', CUSTOMIZATION_VERSION);
    }
