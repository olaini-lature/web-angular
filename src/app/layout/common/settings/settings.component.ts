...
import { CustomizationTailwindService } from '@customization/services/tailwind';
...
export class SettingsComponent implements OnInit, OnDestroy
{
    ...
    constructor(
        ...
        private _customizationTailwindService: CustomizationTailwindService
    )
    {
    }
    ...
    {
        // Get the themes
        this._customizationTailwindService.tailwindConfig$
    ...
    setLayout(layout: string): void
    {
        ...
        this._router.navigate([], {
            ...
            // Set the config
            this._customizationConfigService.config = {layout};
        });
    }
    ...
    {
        this._customizationConfigService.config = {theme};
    }
}
