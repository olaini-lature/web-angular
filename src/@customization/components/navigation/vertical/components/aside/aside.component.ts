...
@Component({
    selector       : 'customization-vertical-navigation-aside-item',
    templateUrl    : './aside.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class CustomizationVerticalNavigationAsideItemComponent implements OnChanges, OnInit, OnDestroy
{
