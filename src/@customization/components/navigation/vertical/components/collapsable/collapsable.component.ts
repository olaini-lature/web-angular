...
@Component({
    selector       : 'customization-vertical-navigation-collapsable-item',
    templateUrl    : './collapsable.component.html',
    animations     : customizationAnimations,
    changeDetection: ChangeDetectionStrategy.OnPush
})
export class CustomizationVerticalNavigationCollapsableItemComponent implements OnInit, OnDestroy
{
    ...
    {
        return {
            'customization-vertical-navigation-item-collapsed': this.isCollapsed,
            'customization-vertical-navigation-item-expanded' : this.isExpanded
        };
    }
    ...
    ngOnInit(): void
    {
        ...
        this._customizationVerticalNavigationComponent.onCollapsableItemCollapsed
        ...
        if ( this.autoCollapse )
        {
            this._customizationVerticalNavigationComponent.onCollapsableItemExpanded
                .pipe(takeUntil(this._unsubscribeAll))
    ...
    collapse(): void
    {
        ...
        this._customizationVerticalNavigationComponent.onCollapsableItemCollapsed.next(this.item);
    }
    ...
    expand(): void
    {
        ...
        // Execute the observable
        this._customizationVerticalNavigationComponent.onCollapsableItemExpanded.next(this.item);
    }
     ...
     * @private
     */
    private _hasActiveChild(item: CustomizationNavigationItem, currentUrl: string): boolean
    {
     ...
     * @private
     */
    private _isChildrenOf(parent: CustomizationNavigationItem, item: CustomizationNavigationItem): boolean
    {
