...
import { FSDocument, FSDocumentElement } from '@customization/components/fullscreen/fullscreen.types';

@Component({
    selector       : 'customization-fullscreen',
    templateUrl    : './fullscreen.component.html',
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'customizationFullscreen'
})
export class CustomizationFullscreenComponent implements OnInit
{
