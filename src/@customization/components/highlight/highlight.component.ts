...
import { CustomizationHighlightService } from '@customization/components/highlight/highlight.service';

@Component({
    selector       : 'textarea[customization-highlight]',
    templateUrl    : './highlight.component.html',
    styleUrls      : ['./highlight.component.scss'],
    encapsulation  : ViewEncapsulation.None,
    changeDetection: ChangeDetectionStrategy.OnPush,
    exportAs       : 'customizationHighlight'
})
export class CustomizationHighlightComponent implements OnChanges, AfterViewInit
{
    @Input() code: string;
    @Input() lang: string;
    ...
    constructor(
        ...
        private _customizationHighlightService: CustomizationHighlightService,
    ...
    private _highlightAndInsert(): void
    {
        ...
        this.highlightedCode = this._domSanitizer.sanitize(SecurityContext.HTML, this._customizationHighlightService.highlight(this.code, this.lang));
