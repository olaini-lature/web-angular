...
import { CustomizationMockApiService } from '@customization/lib/mock-api/mock-api.service';

@Injectable({
    providedIn: 'root'
})
export class CustomizationMockApiInterceptor implements HttpInterceptor
{
    /**
     * Constructor
     */
    constructor(
        @Inject(CUSTOMIZATION_MOCK_API_DEFAULT_DELAY) private _defaultDelay: number,
    ...
    intercept(request: HttpRequest<any>, next: HttpHandler): Observable<HttpEvent<any>>
    {
        ...
        const {
                  handler,
                  urlParams
              } = this._customizationMockApiService.findHandler(request.method.toUpperCase(), request.url);
