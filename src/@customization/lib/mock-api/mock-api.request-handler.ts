...
import { CustomizationMockApiReplyCallback } from '@customization/lib/mock-api/mock-api.types';

export class CustomizationMockApiHandler
{
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: CustomizationMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: CustomizationMockApiReplyCallback): void
    {
        // Store the reply
