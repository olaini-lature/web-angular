...
@Injectable()
export class CustomizationMediaWatcherService
{
    ...
    constructor(
        ...
        private _customizationTailwindConfigService: CustomizationTailwindService
    )
    {
        this._customizationTailwindConfigService.tailwindConfig$.pipe(
