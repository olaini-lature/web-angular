...
import * as extractedTailwindConfigStyle from '@customization/styles/core/tailwind-config.scss';

@Injectable()
export class CustomizationTailwindService
{
    ...
    constructor()
    {
        ...
        const regexpForClass = /\.customization-tailwind-extracted-config\s\{([\s\S]*)\}/g;
