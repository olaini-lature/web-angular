...
const generatePalette = require(path.resolve(__dirname, ('src/@customization/tailwind/utils/generate-palette')));
...
const config = {
    ...
    theme       : {
        ...
        extend  : {
            ...
            typography: (theme) => ({
                DEFAULT: {
                    css: {
                        color              : 'var(--customization-text-default)',
                        '[class~="lead"]'  : {
                            color: 'var(--customization-text-secondary)'
                        },
                        a                  : {
                            color: 'var(--customization-primary-500)'
                        },
                        strong             : {
                            color: 'var(--customization-text-default)'
                        },
                        ...
                        'ul > li::before'  : {
                            backgroundColor: 'var(--customization-text-hint)'
                        },
                        hr                 : {
                            borderColor: 'var(--customization-border)'
                        },
                        blockquote         : {
                            color          : 'var(--customization-text-default)',
                            borderLeftColor: 'var(--customization-border)'
                        },
                        h1                 : {
                            color: 'var(--customization-text-default)'
                        },
                        ...
                        'a code'           : {
                            color: 'var(--customization-primary)'
                        },
                        pre                : {
                        ...
                        thead              : {
                            color            : 'var(--customization-text-default)',
                            borderBottomColor: 'var(--customization-border)'
                        },
                        'tbody tr'         : {
                            borderBottomColor: 'var(--customization-border)'
                        },
    ...
    plugins     : [
        ...
        // customization - Tailwind plugins
        require(path.resolve(__dirname, ('src/@customization/tailwind/plugins/extract-config'))),
        require(path.resolve(__dirname, ('src/@customization/tailwind/plugins/utilities'))),
        require(path.resolve(__dirname, ('src/@customization/tailwind/plugins/icon-size'))),
        require(path.resolve(__dirname, ('src/@customization/tailwind/plugins/theming')))({themes}),
